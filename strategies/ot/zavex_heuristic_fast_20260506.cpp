 ...
 *
 * Based on zavex_heuristic_fast_20260501.cpp with the following update:
 *
 *   1. MCTS book rebuilt 2026-05-02 (6-ship d3 rebuilt with M=500,
 *      EV-terminate-on-uncapped DLL).
 *      The 6-ship sub-book now includes depth-3 entries (100+ new entries);
 *      5-ship and 7-ship sub-books are unchanged from the 2026-04-30 build.
 *      tryBook early-exit guard updated from >2 to >3 to accommodate depth-3.
 *
 * Changes already present in _20260501 vs earlier versions:
 *
 *   2. MCTS book 2026-04-30 rebuild (5/6/7-ship depth-1+2).
 *
 *   3. 6-ship fishing rule updated 2026-04-19 ("rule B"):
 *        Old: nShips == 6 && b >= 2 && n <= 3
 *        New: nShips == 6 && b >= n && n < 5
 *      Tested +12 pts vs old rule on 500 no-book paired games (per page comment).
 *
 *   4. 8-ship (n_colors=9) support added:
 *      - COL_SLOT4 enum value, SHIPS8 array, buildTurn0_8() from TURN0_PROBS[8].
 *      - shipsByCount(8) now returns SHIPS8 instead of {nullptr, 0}.
 *      - Bindings struct extended to 4 slots; tryBook slots array extended to u4.
 *      - Turn-0 fast path extended with n==8 branch.
 *
 * Everything else (enum layout, TURN0_PROBS for 5/6/7-ship, LAMBDA values,
 * backtracker budget=5000, all _fast optimizations) is unchanged from
 * zavex_heuristic_fast.cpp.
 *
...
enum Color : uint8_t {
    ...
    COL_SLOT4   = 12,  // u4
    COL_UNKNOWN = 15,
    N_COLORS    = 13   // valid indices 0..12
};
...
static inline bool isSlot(Color c) { return c >= COL_SLOT1 && c <= COL_SLOT4; }
...
static constexpr int MAX_SHIPS = 8;
...
static constexpr ShipEntry SHIPS8[8] = {
    { COL_TEAL, 4 }, { COL_GREEN, 3 }, { COL_YELLOW, 3 },
    { COL_ORANGE, 2 }, { COL_SLOT1, 2 }, { COL_SLOT2, 2 }, { COL_SLOT3, 2 }, { COL_SLOT4, 2 }
};
...
static Turn0ProbEntry buildTurn0_8() {
    // Source: TURN0_PROBS[8] from https://ouro-trace.zavex.workers.dev/
    // HV slots remapped: Light→SLOT1, Dark→SLOT2, Red→SLOT3, Rainbow→SLOT4.
    // All four HV slots share equal probability at every cell (symmetric).
    return {{
        makeProb({{COL_TEAL,0.152210},{COL_GREEN,0.098567},{COL_YELLOW,0.098567},{COL_ORANGE,0.071160},{COL_SLOT1,0.071160},{COL_SLOT2,0.071160},{COL_SLOT3,0.071160},{COL_SLOT4,0.071160},{COL_BLUE,0.294855}}),
        makeProb({{COL_TEAL,0.188064},{COL_GREEN,0.110808},{COL_YELLOW,0.110808},{COL_ORANGE,0.081400},{COL_SLOT1,0.081400},{COL_SLOT2,0.081400},{COL_SLOT3,0.081400},{COL_SLOT4,0.081400},{COL_BLUE,0.183323}}),
        makeProb({{COL_TEAL,0.178291},{COL_GREEN,0.157417},{COL_YELLOW,0.157417},{COL_ORANGE,0.067534},{COL_SLOT1,0.067534},{COL_SLOT2,0.067534},{COL_SLOT3,0.067534},{COL_SLOT4,0.067534},{COL_BLUE,0.169204}}),
        makeProb({{COL_TEAL,0.188064},{COL_GREEN,0.110808},{COL_YELLOW,0.110808},{COL_ORANGE,0.081400},{COL_SLOT1,0.081400},{COL_SLOT2,0.081400},{COL_SLOT3,0.081400},{COL_SLOT4,0.081400},{COL_BLUE,0.183323}}),
        makeProb({{COL_TEAL,0.152210},{COL_GREEN,0.098567},{COL_YELLOW,0.098567},{COL_ORANGE,0.071160},{COL_SLOT1,0.071160},{COL_SLOT2,0.071160},{COL_SLOT3,0.071160},{COL_SLOT4,0.071160},{COL_BLUE,0.294855}}),
        makeProb({{COL_TEAL,0.188064},{COL_GREEN,0.110808},{COL_YELLOW,0.110808},{COL_ORANGE,0.081400},{COL_SLOT1,0.081400},{COL_SLOT2,0.081400},{COL_SLOT3,0.081400},{COL_SLOT4,0.081400},{COL_BLUE,0.183323}}),
        makeProb({{COL_TEAL,0.143417},{COL_GREEN,0.109181},{COL_YELLOW,0.109181},{COL_ORANGE,0.089563},{COL_SLOT1,0.089563},{COL_SLOT2,0.089563},{COL_SLOT3,0.089563},{COL_SLOT4,0.089563},{COL_BLUE,0.190404}}),
        makeProb({{COL_TEAL,0.123871},{COL_GREEN,0.127901},{COL_YELLOW,0.127901},{COL_ORANGE,0.087201},{COL_SLOT1,0.087201},{COL_SLOT2,0.087201},{COL_SLOT3,0.087201},{COL_SLOT4,0.087201},{COL_BLUE,0.184321}}),
        makeProb({{COL_TEAL,0.143417},{COL_GREEN,0.109181},{COL_YELLOW,0.109181},{COL_ORANGE,0.089563},{COL_SLOT1,0.089563},{COL_SLOT2,0.089563},{COL_SLOT3,0.089563},{COL_SLOT4,0.089563},{COL_BLUE,0.190404}}),
        makeProb({{COL_TEAL,0.188064},{COL_GREEN,0.110808},{COL_YELLOW,0.110808},{COL_ORANGE,0.081400},{COL_SLOT1,0.081400},{COL_SLOT2,0.081400},{COL_SLOT3,0.081400},{COL_SLOT4,0.081400},{COL_BLUE,0.183323}}),
        makeProb({{COL_TEAL,0.178291},{COL_GREEN,0.157417},{COL_YELLOW,0.157417},{COL_ORANGE,0.067534},{COL_SLOT1,0.067534},{COL_SLOT2,0.067534},{COL_SLOT3,0.067534},{COL_SLOT4,0.067534},{COL_BLUE,0.169204}}),
        makeProb({{COL_TEAL,0.123871},{COL_GREEN,0.127901},{COL_YELLOW,0.127901},{COL_ORANGE,0.087201},{COL_SLOT1,0.087201},{COL_SLOT2,0.087201},{COL_SLOT3,0.087201},{COL_SLOT4,0.087201},{COL_BLUE,0.184321}}),
        makeProb({{COL_TEAL,0.104325},{COL_GREEN,0.141274},{COL_YELLOW,0.141274},{COL_ORANGE,0.086970},{COL_SLOT1,0.086970},{COL_SLOT2,0.086970},{COL_SLOT3,0.086970},{COL_SLOT4,0.086970},{COL_BLUE,0.178280}}),
        makeProb({{COL_TEAL,0.123871},{COL_GREEN,0.127901},{COL_YELLOW,0.127901},{COL_ORANGE,0.087201},{COL_SLOT1,0.087201},{COL_SLOT2,0.087201},{COL_SLOT3,0.087201},{COL_SLOT4,0.087201},{COL_BLUE,0.184321}}),
        makeProb({{COL_TEAL,0.178291},{COL_GREEN,0.157417},{COL_YELLOW,0.157417},{COL_ORANGE,0.067534},{COL_SLOT1,0.067534},{COL_SLOT2,0.067534},{COL_SLOT3,0.067534},{COL_SLOT4,0.067534},{COL_BLUE,0.169204}}),
        makeProb({{COL_TEAL,0.188064},{COL_GREEN,0.110808},{COL_YELLOW,0.110808},{COL_ORANGE,0.081400},{COL_SLOT1,0.081400},{COL_SLOT2,0.081400},{COL_SLOT3,0.081400},{COL_SLOT4,0.081400},{COL_BLUE,0.183323}}),
        makeProb({{COL_TEAL,0.143417},{COL_GREEN,0.109181},{COL_YELLOW,0.109181},{COL_ORANGE,0.089563},{COL_SLOT1,0.089563},{COL_SLOT2,0.089563},{COL_SLOT3,0.089563},{COL_SLOT4,0.089563},{COL_BLUE,0.190404}}),
...
// MCTS book: 5-ship and 7-ship rebuilt 2026-04-30; 6-ship d3 rebuilt 2026-05-02.
// Verbatim from https://ouro-trace.zavex.workers.dev/mcts_book.js
static MctsBooks buildMctsBooks() {
    ...
    books[5] = {
        ...
        {"0,Blue;7,Teal", 12},
        {"0,Green", 2},
        {"0,Green;10,Orange", 22},
        {"0,Green;10,u1", 22},
        {"0,Green;12,Orange", 17},
        {"0,Green;12,Teal", 10},
        {"0,Green;12,Yellow", 13},
        {"0,Green;12,u1", 13},
        {"0,Green;2,Orange", 14},
        {"0,Green;2,Teal", 16},
        {"0,Green;2,Yellow", 4},
        ...
        {"0,Orange;4,u1", 1},
        {"0,Orange;5,Green", 22},
        {"0,Orange;5,Orange", 11},
        {"0,Orange;5,Yellow", 22},
        {"0,Orange;5,u1", 6},
        {"0,Teal", 2},
        {"0,Teal;12,Green", 10},
        {"0,Teal;12,Orange", 7},
        ...
        {"0,Yellow;1,Green", 11},
        {"0,Yellow;1,Teal", 16},
        {"0,Yellow;10,Orange", 22},
        {"0,Yellow;10,u1", 22},
        {"0,Yellow;2,Orange", 14},
        {"0,Yellow;2,Teal", 16},
        {"0,Yellow;2,u1", 14},
        {"0,u1", 4},
        {"0,u1;1,u1", 17},
    ...
    books[6] = {
        ...
        {"6,Green;8,Green", 2},
        {"6,Orange;8,Green", 11},
        {"6,Orange;8,Yellow", 11},
        {"6,Yellow;8,Yellow", 16},
        {"6,u1;8,Green", 11},
        {"6,u1;8,Yellow", 11},
        {"7,Green;8,Yellow", 3},
        {"7,Orange;8,Orange", 17},
        {"7,Orange;8,Yellow", 2},
        {"7,Teal;8,Orange", 22},
        {"7,Teal;8,Yellow", 3},
        {"7,Teal;8,u1", 22},
        {"7,Yellow;8,Yellow", 16},
        {"7,Yellow;8,u1", 13},
        {"7,u1;8,Orange", 3},
        {"7,u1;8,Yellow", 2},
        {"7,u1;8,u1", 17},
        ...
        {"8,Green;18,Orange", 6},
        {"8,Green;18,u1", 17},
        {"8,Orange;12,Yellow", 16},
        {"8,Orange;12,u1", 13},
        {"8,Orange;13,Orange", 11},
        {"8,Teal;11,Green", 6},
        {"8,Teal;11,u1", 16},
        {"8,Teal;12,Blue", 23},
        {"8,Teal;12,Green", 5},
        ...
        {"8,u1;13,u1", 11},
        {"8,u1;13,u2", 14},
        // depth 3 (rebuilt 2026-05-02)
        {"0,Green;5,Blue;8,Teal", 12},
        {"0,Green;8,Orange;13,Blue", 9},
        {"0,Orange;5,Blue;8,Teal", 11},
        {"0,Teal;7,Blue;8,u1", 11},
        {"0,Teal;8,Orange;13,Blue", 17},
        {"0,Yellow;5,Blue;8,Teal", 23},
        {"0,Yellow;6,Blue;8,Green", 17},
        {"0,Yellow;7,Blue;8,u1", 16},
        {"0,Yellow;8,Orange;13,Blue", 9},
        {"0,u1;5,Blue;8,Teal", 23},
        {"0,u1;7,Blue;8,u2", 13},
        {"0,u1;8,Blue;18,Green", 16},
        {"0,u1;8,Blue;18,Yellow", 16},
        {"2,Blue;7,u1;8,u2", 13},
        {"2,Green;7,u1;8,u2", 10},
        {"2,Orange;7,u1;8,u2", 3},
        {"2,Teal;6,Green;8,Green", 10},
        {"2,Teal;7,u1;8,u2", 12},
        {"2,Yellow;6,Green;8,Green", 10},
        {"2,Yellow;7,u1;8,u2", 13},
        {"2,u1;7,u1;8,u2", 16},
        {"5,Green;8,Teal;23,Blue", 17},
        {"5,Green;8,Teal;23,Orange", 18},
        {"5,Green;8,Teal;23,Teal", 7},
        {"5,Green;8,Teal;23,Yellow", 12},
        {"5,Orange;6,Blue;8,Teal", 17},
        {"5,Orange;6,Green;8,Teal", 16},
        {"5,Orange;6,Teal;8,Teal", 10},
        {"5,Orange;6,Yellow;8,Teal", 16},
        {"5,Orange;6,u1;8,Teal", 1},
        {"5,Teal;8,Teal;18,Green", 16},
        {"5,Teal;8,Teal;18,Orange", 17},
        {"5,Teal;8,Teal;18,Yellow", 17},
        {"5,Teal;8,Teal;18,u1", 11},
        {"5,Yellow;6,Blue;8,Teal", 16},
        {"5,Yellow;6,Green;8,Teal", 15},
        {"5,Yellow;6,Orange;8,Teal", 1},
        {"5,Yellow;6,Teal;8,Teal", 15},
        {"5,Yellow;6,Yellow;8,Teal", 16},
        {"5,Yellow;6,u1;8,Teal", 1},
        {"5,u1;6,Blue;8,Teal", 16},
        {"5,u1;6,Green;8,Teal", 16},
        {"5,u1;6,Orange;8,Teal", 1},
        {"5,u1;6,Teal;8,Teal", 10},
        {"5,u1;6,Yellow;8,Teal", 16},
        {"5,u1;6,u1;8,Teal", 16},
        {"5,u1;6,u2;8,Teal", 1},
        {"6,Green;8,Blue;18,Teal", 12},
        {"6,Green;8,Yellow;18,Blue", 12},
        {"6,Green;8,Yellow;18,Orange", 9},
        {"6,Green;8,Yellow;18,Teal", 21},
        {"6,Green;8,Yellow;18,u1", 9},
        {"6,Orange;8,Blue;18,Teal", 1},
        {"6,Orange;8,Green;11,Blue", 5},
        {"6,Orange;8,Green;11,Teal", 1},
        {"6,Orange;8,Green;11,Yellow", 7},
        {"6,Orange;8,Green;11,u1", 1},
        {"6,Orange;8,Yellow;11,Blue", 18},
        {"6,Orange;8,Yellow;11,Teal", 1},
        {"6,Orange;8,Yellow;11,u1", 1},
        {"6,Teal;8,Green;18,Green", 10},
        {"6,Teal;8,Green;18,Orange", 3},
        {"6,Teal;8,Green;18,Yellow", 15},
        {"6,Teal;8,Green;18,u1", 19},
        {"6,Teal;8,Yellow;18,Green", 3},
        {"6,Teal;8,Yellow;18,Orange", 19},
        {"6,Teal;8,Yellow;18,Yellow", 2},
        {"6,Teal;8,Yellow;18,u1", 19},
        {"6,Yellow;8,Green;16,Blue", 12},
        {"6,Yellow;8,Green;16,Orange", 5},
        {"6,Yellow;8,Green;16,Teal", 23},
        {"6,Yellow;8,Green;16,u1", 5},
        {"6,Yellow;8,Yellow;16,Blue", 2},
        {"6,Yellow;8,Yellow;16,Teal", 2},
        {"6,u1;8,Blue;18,Teal", 1},
        {"6,u1;8,Green;11,Blue", 5},
        {"6,u1;8,Green;11,Orange", 1},
        {"6,u1;8,Green;11,Teal", 1},
        {"6,u1;8,Green;11,Yellow", 7},
        {"6,u1;8,Green;11,u2", 1},
        {"6,u1;8,Yellow;11,Blue", 5},
        {"6,u1;8,Yellow;11,Orange", 1},
        {"6,u1;8,Yellow;11,Teal", 1},
        {"6,u1;8,Yellow;11,u2", 1},
        {"7,Blue;8,Orange;13,Green", 18},
        {"7,Green;8,Orange;13,Teal", 23},
        {"7,Green;8,u1;13,Blue", 5},
        {"7,Green;8,u1;13,Orange", 18},
        {"7,Green;8,u1;13,Teal", 23},
        {"7,Green;8,u1;13,Yellow", 9},
        {"7,Green;8,u1;13,u2", 18},
        {"7,Orange;8,u1;12,Blue", 9},
        {"7,Orange;8,u1;12,Green", 9},
        {"7,Orange;8,u1;12,Teal", 2},
        {"7,Orange;8,u1;12,Yellow", 3},
        {"7,Orange;8,u1;12,u2", 13},
        {"7,Teal;8,Orange;13,Green", 9},
        {"7,Teal;8,u1;22,Blue", 6},
        {"7,Teal;8,u1;22,Green", 9},
        {"7,Teal;8,u1;22,Orange", 9},
        {"7,Teal;8,u1;22,Teal", 13},
        {"7,Teal;8,u1;22,Yellow", 9},
        {"7,Teal;8,u1;22,u2", 9},
        {"7,Yellow;8,Orange;13,Green", 17},
        {"7,Yellow;8,Orange;13,Teal", 23},
        {"7,Yellow;8,u1;13,Green", 3},
        {"7,Yellow;8,u1;13,Orange", 14},
        {"7,Yellow;8,u1;13,Teal", 23},
        {"7,Yellow;8,u1;13,u2", 14},
        {"7,u1;8,Orange;13,Green", 6},
        {"7,u1;8,Orange;13,Teal", 3},
        {"7,u1;8,u1;17,Blue", 21},
        {"7,u1;8,u1;17,Orange", 16},
        {"7,u1;8,u1;17,Teal", 19},
        {"7,u1;8,u1;17,Yellow", 11},
        {"7,u1;8,u1;17,u2", 16},
        {"8,Blue;13,Green;18,Orange", 19},
        {"8,Blue;13,Green;18,u1", 19},
        {"8,Blue;13,Orange;18,u1", 23},
        {"8,Blue;13,Teal;18,u1", 19},
        {"8,Blue;13,Yellow;18,u1", 19},
        {"8,Blue;13,u1;18,Orange", 17},
        {"8,Blue;13,u1;18,u2", 17},
        {"8,Orange;11,Blue;13,Orange", 15},
        {"8,Orange;11,Green;13,Yellow", 7},
        {"8,Orange;11,Teal;13,Orange", 1},
        {"8,Orange;11,Teal;13,Yellow", 9},
        {"8,Orange;11,Yellow;13,Orange", 17},
        {"8,Orange;11,u1;13,Yellow", 10},
        {"8,Orange;12,Blue;13,u1", 3},
        {"8,Orange;12,Green;13,u1", 3},
        {"8,Orange;12,Teal;13,u1", 14},
        {"8,Orange;12,Yellow;13,u1", 3},
        {"8,Orange;12,u1;13,u2", 11},
    };
...
struct Bindings {
    ...
    Color slotToReal[4];  // indexed 0=u1, 1=u2, 2=u3, 3=u4
    int   nextSlot;       // 0..4: how many HV colors have been bound

    Bindings() : nextSlot(0) {
        slotToReal[0] = slotToReal[1] = slotToReal[2] = slotToReal[3] = COL_UNKNOWN;
    }
...
static int tryBook(const RevealedState& rev, int nShips) {
    // Early exit: all book entries have at most 3 revealed cells in the key
    // (6-ship book includes depth-3 entries; 5-ship and 7-ship are depth-2 max)
    if (rev.count() > 3) return -1;
    ...
    for (int m = rev.mask; m; m &= m - 1) {
        ...
        if (isHV(col)) {
            ...
            // "u1", "u2", "u3"
            static const char* slots[] = { "u1", "u2", "u3", "u4" };
    ...
    int b, int n, int nShips)
{
    ...
    // Fishing mode
    // 6-ship rule B (adopted 2026-04-19): fish when b >= n AND n < 5.
